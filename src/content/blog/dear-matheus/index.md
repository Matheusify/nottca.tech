...
![Matheus' profile, with his display name set to "Taking a Break." and his profile picture being slightly darker](./images/update-1-taking-a-break.png)
...
![Matheus saying that the post is all lies](./images/update-1-lies.png)
...
![Matheus' profile, showing that it is back to normal](./images/update-2-comeback.png)
...
![Matheus' profile, with his display name set as "Evilify", with the same red profile picture from the incident](./images/update-2-evilify.png)
...
![Matheus' profile, showing his about me that says "Kys toast"](./images/update-2-kys.png)
...
![A screenshot of Matheus' apology on his community tab on YouTube](./images/update-2-apology.png)
...
![A back-and-forth between me and Matheus talking about how I don't want him to know](./images/begging-to-know.png)
![Matheus telling me that he has changed and that he won't do it again](./images/i-am-more-mature.png)
...
![Matheus telling me "if you tell me I gonna stop hating on yabc"](./images/if-you-tell-me-i-gonna-stop-hating-on-yabc.png)
...
![Me telling Matheus to stop because I was criyng](./images/please-stop.png)

Does he stop? Of course not, he doubles down!

![Matheus asking me "do you want me to continue hating on yabc?"](./images/doubling-down-on-hating-on-yabc.png)

At this point, I'm just screaming and begging him to stop, but he triples down and says that he doesn't care.

![Me begging Matheus to stop, and Matheus saying he doesn't care](./images/i-do-not-care.png)
...
![Matheus saying that he's a narcissist](./images/im-a-narcissist.png)
...
![Me saying that I "can't believe Matheus is trying to blackmail me over my biggest secret", and Matheus agreeing](./images/matheus-admitting-to-blackmailing-me.png)

And then Matheus tells me that he could "end my 2 streams if [he] feels like it," which to me sounds like a threat.

![Matheus threatening to end my 2 streams](./images/i-can-end-your-2-streams.png)
...
![Matheus saying that he has "no plan on apologizing for what I said that caused all of that to happen"](./images/i-have-no-plan-on-apologizing.png)

Later on in the conversation, he changes everything about his profile to just question marks.

![???](./images/question-marks.png)
...
![A screenshot of Matheus' profile, with his status saying "Not apologizing as I believe I am not in the wrong."](./images/i-believe-i-am-not-in-the-wrong.png)

</div>

His about me also says "Things are not how they seem" in morse code.

![A translated version of his about me](./images/things-are-not-how-they-seem.png)
...
![Matheus saying that for him blackmail is okay](./images/blackmail-is-okay-for-me.png)
...
![Matheus saying that he can blackmail his own best friend so he doesn't care about blackmail](./images/i-can-blackmail-my-own-best-friend.png)
...
![Matheus saying that everything he did was normal](./images/you-saw-him-cry-and-you-continued.png)
...
![Matheus saying that he can just say that it's all lies](./images/i-can-just-say-its-all-lies.png)
...
![Matheus saying that he was curious](./images/i-was-curious-af.png)
...
![Matheus saying that he's the only one with manager now](./images/im-the-only-one-with-manager-now.png)
...
![Matheus saying that he gave everyone back their permissions, and also how he still won't apologize](./images/bro-finally-became-a-good-person.png)
...
![Matheus saying that it was all a character](./images/it-was-all-a-character.png)
...
![A screenshot showing that I blocked Matheus](./images/blocked.png)
